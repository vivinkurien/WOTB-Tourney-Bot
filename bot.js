...
var TANK_TOKEN = process.env.TANK_TOKEN;
    ...
    if(message.toLocaleLowerCase().startsWith("!register"))
     ...
     if(message.toLocaleLowerCase().startsWith("!tourney"))
     {
        ...
        var options = {
            ...
            path:'/wotb/tournaments/list/?application_id='+TANK_TOKEN+'&status=upcoming%2Cregistration_started%2Cregistration_finished%2Crunning',
            method: 'GET'
        };
...
const getTournaments = function (cb) {
        let resultArray = []
        let tournamentURL = 'http://api.wotblitz.com/wotb/tournaments/list/?application_id='+TANK_TOKEN+'&status=upcoming%2Cregistration_started%2Cregistration_finished%2Crunning'
    ...
    const getAllTeamDetails = function (resultArray, cb) {
        ...
        return new Promise(function (resolve, reject) {
            const teamInfoURL = 'http://api.wotblitz.com/wotb/tournaments/teams/?application_id='+TANK_TOKEN+'&tournament_id='
